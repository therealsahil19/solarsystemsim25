...
`)}const gp=new zt;function DE(i){Kt._getMatrix(gp,Kt.workingColorSpace,i);const t=`mat3( ${gp.elements.map(e=>e.toFixed(4))} )`;switch(Kt.getTransfer(i)){case Dl:return[t,"LinearTransferOETF"];case ne:return[t,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",i),[t,"LinearTransferOETF"]}}function _p(i,t,e){const n=i.getShaderParameter(t,i.COMPILE_STATUS),r=(i.getShaderInfoLog(t)||"").trim();if(n&&r==="")return"";const o=/ERROR: 0:(\d+)/.exec(r);if(o){const a=parseInt(o[1]);return e.toUpperCase()+`
