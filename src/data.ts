...
export const planetData: CelestialBody[] = [
    ...
    { name: 'Earth', radius: 6371, color: 0x4d90fe, semiMajorAxis: 1.0, orbitalPeriod: 365.2, eccentricity: 0.017, texture: 'assets/earth.jpeg', moons: [
        { name: 'Moon', radius: 1737, color: 0xcccccc, semiMajorAxis: 0.015, orbitalPeriod: 27.3, semiMajorAxisKm: 384400 }
    ]},
    { name: 'Mars', radius: 3390, color: 0xff0000, semiMajorAxis: 1.524, orbitalPeriod: 687.0, eccentricity: 0.093, texture: 'assets/8k_mars.jpg' },
    { name: 'Jupiter', radius: 69911, color: 0xffd8ad, semiMajorAxis: 5.204, orbitalPeriod: 4331, axialTilt: 3.08, eccentricity: 0.048, texture: 'assets/2k_jupiter.jpg',
        rings: {
            type: 'jupiter',
    ...
    { name: 'Saturn', radius: 58232, color: 0xf0e5c8, semiMajorAxis: 9.582, orbitalPeriod: 10747, axialTilt: 26.73, eccentricity: 0.054, texture: 'assets/8k_saturn.jpg',
        rings: {
            type: 'saturn',
    ...
    { name: 'Uranus', radius: 25362, color: 0xAFDBF5, semiMajorAxis: 19.229, orbitalPeriod: 30589, axialTilt: 97.92, eccentricity: 0.047, texture: 'assets/2k_uranus.jpg',
        rings: {
            type: 'uranus',
    ...
    { name: 'Neptune', radius: 24622, color: 0x3d5ef5, semiMajorAxis: 30.109, orbitalPeriod: 59800, axialTilt: 29.6, eccentricity: 0.009, texture: 'assets/2k_neptune.jpg',
        rings: {
            type: 'neptune',
