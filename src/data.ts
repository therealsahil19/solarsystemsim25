...
export const celestialBodyData: CelestialBody[] = [
    { id: 'sun', parentId: null, name: 'Sun', type: 'star', radius: 696340, mass: 1988500, density: 1408, surfaceGravity: 274, color: 0xffff00, semiMajorAxis: 0, orbitalPeriod: 1, eccentricity: 0, texture: null,
        edu: {
    ...
    { id: 'mercury', parentId: 'sun', name: 'Mercury', type: 'planet', radius: 2440, mass: 0.33011, density: 5427, surfaceGravity: 3.7, inclination: 7.005, color: 0x888888, semiMajorAxis: 0.387, orbitalPeriod: 88.0, eccentricity: 0.206, texture: '/assets/8k_mercury.jpg',
        edu: {
    ...
    { id: 'venus', parentId: 'sun', name: 'Venus', type: 'planet', radius: 6052, mass: 4.8675, density: 5243, surfaceGravity: 8.87, inclination: 3.39, color: 0xeeeeaa, semiMajorAxis: 0.723, orbitalPeriod: 224.7, eccentricity: 0.007, texture: '/assets/4k_venus_atmosphere.jpg',
        edu: {
    ...
    { id: 'mars', parentId: 'sun', name: 'Mars', type: 'planet', radius: 3390, mass: 0.64171, density: 3933, surfaceGravity: 3.721, inclination: 1.850, color: 0xff0000, semiMajorAxis: 1.524, orbitalPeriod: 687.0, eccentricity: 0.093, texture: '/assets/8k_mars.jpg',
        edu: {
    ...
    { id: 'jupiter', parentId: 'sun', name: 'Jupiter', type: 'planet', radius: 69911, mass: 1898.19, density: 1326, surfaceGravity: 24.79, inclination: 1.305, color: 0xffd8ad, semiMajorAxis: 5.204, orbitalPeriod: 4331, axialTilt: 3.08, eccentricity: 0.048, texture: '/assets/2k_jupiter.jpg',
    ...
    { id: 'saturn', parentId: 'sun', name: 'Saturn', type: 'planet', radius: 58232, mass: 568.34, density: 687, surfaceGravity: 10.44, inclination: 2.485, color: 0xf0e5c8, semiMajorAxis: 9.582, orbitalPeriod: 10747, axialTilt: 26.73, eccentricity: 0.054, texture: '/assets/8k_saturn.jpg',
    ...
    { id: 'uranus', parentId: 'sun', name: 'Uranus', type: 'planet', radius: 25362, mass: 86.813, density: 1270, surfaceGravity: 8.69, inclination: 0.772, color: 0xAFDBF5, semiMajorAxis: 19.229, orbitalPeriod: 30589, axialTilt: 97.92, eccentricity: 0.047, texture: '/assets/2k_uranus.jpg',
    ...
    { id: 'neptune', parentId: 'sun', name: 'Neptune', type: 'planet', radius: 24622, mass: 102.413, density: 1638, surfaceGravity: 11.15, inclination: 1.769, color: 0x3d5ef5, semiMajorAxis: 30.109, orbitalPeriod: 59800, axialTilt: 29.6, eccentricity: 0.009, texture: '/assets/2k_neptune.jpg',
    ...
    // Moons
    { id: 'moon', parentId: 'earth', name: 'Moon', type: 'moon', radius: 1737, mass: 0.07346, density: 3344, surfaceGravity: 1.62, inclination: 5.145, color: 0xcccccc, semiMajorAxis: 0, semiMajorAxisKm: 384400, orbitalPeriod: 27.3, eccentricity: 0.0549, texture: null,
        edu: {
    ...
    { id: 'io', parentId: 'jupiter', name: 'Io', type: 'moon', radius: 1821, color: 0xE5C851, semiMajorAxis: 0, semiMajorAxisKm: 421600, orbitalPeriod: 1.77, eccentricity: 0.0041, texture: null },
    { id: 'europa', parentId: 'jupiter', name: 'Europa', type: 'moon', radius: 1560, color: 0x8B7D82, semiMajorAxis: 0, semiMajorAxisKm: 670900, orbitalPeriod: 3.55, eccentricity: 0.009, texture: null },
    { id: 'ganymede', parentId: 'jupiter', name: 'Ganymede', type: 'moon', radius: 2634, color: 0x9E978E, semiMajorAxis: 0, semiMajorAxisKm: 1070000, orbitalPeriod: 7.15, eccentricity: 0.0013, texture: null },
    { id: 'callisto', parentId: 'jupiter', name: 'Callisto', type: 'moon', radius: 2410, color: 0x5C5C5C, semiMajorAxis: 0, semiMajorAxisKm: 1883000, orbitalPeriod: 16.69, eccentricity: 0.0074, texture: null },
    { id: 'mimas', parentId: 'saturn', name: 'Mimas', type: 'moon', radius: 198, color: 0xcccccc, semiMajorAxis: 0, semiMajorAxisKm: 185539, orbitalPeriod: 0.94, eccentricity: 0.0196, texture: null },
    { id: 'enceladus', parentId: 'saturn', name: 'Enceladus', type: 'moon', radius: 250, color: 0xcccccc, semiMajorAxis: 0, semiMajorAxisKm: 238042, orbitalPeriod: 1.4, eccentricity: 0.0047, texture: null },
    { id: 'titan', parentId: 'saturn', name: 'Titan', type: 'moon', radius: 2575, color: 0xcccccc, semiMajorAxis: 0, semiMajorAxisKm: 1221865, orbitalPeriod: 16, eccentricity: 0.0288, texture: null },
    { id: 'iapetus', parentId: 'saturn', name: 'Iapetus', type: 'moon', radius: 718, color: 0xcccccc, semiMajorAxis: 0, semiMajorAxisKm: 3560854, orbitalPeriod: 79.33, eccentricity: 0.0283, texture: null },
    { id: 'miranda', parentId: 'uranus', name: 'Miranda', type: 'moon', radius: 236, color: 0xcccccc, semiMajorAxis: 0, semiMajorAxisKm: 129846, orbitalPeriod: 1.413, eccentricity: 0.0013, texture: null },
    { id: 'ariel', parentId: 'uranus', name: 'Ariel', type: 'moon', radius: 579, color: 0xcccccc, semiMajorAxis: 0, semiMajorAxisKm: 190929, orbitalPeriod: 2.520, eccentricity: 0.0012, texture: null },
    { id: 'umbriel', parentId: 'uranus', name: 'Umbriel', type: 'moon', radius: 585, color: 0xcccccc, semiMajorAxis: 0, semiMajorAxisKm: 265986, orbitalPeriod: 4.144, eccentricity: 0.0039, texture: null },
    { id: 'titania', parentId: 'uranus', name: 'Titania', type: 'moon', radius: 789, color: 0xcccccc, semiMajorAxis: 0, semiMajorAxisKm: 436298, orbitalPeriod: 8.706, eccentricity: 0.0011, texture: null },
    { id: 'proteus', parentId: 'neptune', name: 'Proteus', type: 'moon', radius: 209, color: 0xcccccc, semiMajorAxis: 0, semiMajorAxisKm: 117600, orbitalPeriod: 1.122, eccentricity: 0.0005, texture: null },
    { id: 'triton', parentId: 'neptune', name: 'Triton', type: 'moon', radius: 1350, color: 0xcccccc, semiMajorAxis: 0, semiMajorAxisKm: 354760, orbitalPeriod: -5.877, eccentricity: 0.000016, texture: null },
    { id: 'nereid', parentId: 'neptune', name: 'Nereid', type: 'moon', radius: 170, color: 0xcccccc, semiMajorAxis: 0, semiMajorAxisKm: 5513400, orbitalPeriod: 360.13, eccentricity: 0.7507, texture: null },
];
